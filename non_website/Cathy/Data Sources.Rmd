...
* **[BechdelTest.com](http://bechdeltest.com)**: The site is user-operated database where fans can rate films based on the criteria of the Bechdel Test. The site has detailed, coded information about the year, title, and whether it passes each level of the Bechdel Test requirements (see [Data Cleaning](Data Sources.html#Data_cleaning) for further information about scoring).
...
The table below displays the full tidied dataset.
