...
table %>% 
  ...
  add_trace(y = ~n...6, name = "Don't talk to each other") %>% 
  add_trace(y = ~n...9, name = "Only talk about men") %>% 
  add_trace(y = ~n...12, name = "Dubious") %>% 
  add_trace(y = ~n...15, name = "Passes Bechdel") %>% 
